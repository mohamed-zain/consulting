...
<div class="image-container set-full-height" style="background-image: url('public/slide3.jpg')">
                    ...
                    <div class="card wizard-card" data-color="orange" id="wizard">
                        ...
                        <!--        You can switch " data-color="blue" "  with one of the next bright colors: "green", "orange", "red", "purple"             -->
                            ...
                            <div class="wizard-navigation">
                                <ul>
                                    <li><a href="#details" data-toggle="tab">بيانات المشروع</a></li>
                                    <li><a href="#captain" data-toggle="tab">  متطلبات التصميم </a></li>
                                    <li><a href="#activity" data-toggle="tab">   ملفات التصاميم </a></li>
    ...
    <div class="footer">
        <div class="container text-center">
            <a href=""> جميع الحقوق محفوظة © 2020 - 2030 - خيرعون للاستشارات الهندسية   </a>
        </div>
    </div>
</div>
<script>

            ...
            <div class="box-body" style="direction: ltr">
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-3">
                        ...
                        <input type="text" name="DRP" class="form-control" id="DRP" placeholder=" 24/6/2020" style="margin-bottom: 9px;" required>
                    </div>

                    <div class="col-lg-3">
                        <label for="BranchID" class="control-label">Submission Of Application</label>
                        <input type="text" name="SOA" class="form-control" id="SOA" placeholder="RQ2 -KZ-DKO-214-JED" style="margin-bottom: 9px;" required>
                    </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-4">
                        ...
                        <select name="hhh" class="form-control select2" id="mission_required"   style="margin-bottom: 9px;" required>

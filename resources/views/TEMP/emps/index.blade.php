        ...
        <div class="box box-default">
            ...
            <div class="box-body">
                <div class="" style="margin-bottom: 20px">
                    <a href="{{ url('emoployeeCreate2') }}" class="btn btn-info" name="emoployeeCreate" id="Town"><i class="fa fa-plus"></i> اضافة موظف</a>
                ...
                <table id="example1" class="table table-bordered table-striped">
                    ...
                    @foreach($Data as $Single)
                        <tr>
                            ...
                            <td>{{$Single->Email}}</td>
                            <td><a href="{{url('EditEmp2')}}/{{ $Single->emp_id }}" class="CMe"><i class="fa fa-edit btn btn-warning"></i></a></td>
                            <td><a href="{{url('ShowEmp2')}}/{{ $Single->emp_id }}"><i class="fa  fa-eye btn btn-info"></i></a></td>

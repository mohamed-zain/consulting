...
<div class="">
  <section class="content-header">
        <div class="">
          <h3>
            لوحة التحكم
            <small>المشاريع التي لم يتم فتح بطاقة عمل لها</small>
          </h3>
          <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-dashboard"></i> الرئيسية</a></li>
            <li class="active">ادارة المشاريع</li>
            <li class="active">قائمة الانتظار</li>
          </ol>
          </div>
        </section>
</div>
...
<div class="col-md-12">
  <div class="box box-default">
    <div class="box-header with-border">
      <h3 class="box-title">قائمة المشاريع التي لا تحتوي علي (Job Card)</h3>
...
<table id="example1" class="table table-bordered table-striped table-responsive">
                  ...
                  <td>
                      <div class="btn-group">
                          ...
                          <ul class="dropdown-menu" role="menu">
                              ...
                              @endif
                              <li><a href="#"  data-toggle="modal" data-target="#archive{{ $mmmmmm->number }}">ارشفة المشروع</a></li>
                              <li><a href="#"  data-toggle="modal" data-target="#frozen{{ $mmmmmm->number }}"> تجميد المشروع</a></li>
                ...
                <div class="modal fade" id="archive{{ $mmmmmm->number }}" role="dialog">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
                                <button type="button" class="close" data-dismiss="modal">&times;</button>
                                <h4 class="modal-title">ارشفة المشروع</h4>
                            </div>
                            <div class="modal-body">
                                <div class="row">
                                    <div class="col-md-12">
                                        <form action="{{ route('ArchivePro')}}" method="post">
                                            {{ csrf_field() }}

                                            <input type="hidden" name="id" value="{{ $mmmmmm->AID }}">

                                            <button type="submit" class="btn btn-success">ارشفة المشروع</button>
                                        </form>
                ...
                <div class="modal fade" id="frozen{{ $mmmmmm->number }}" role="dialog">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
                                <button type="button" class="close" data-dismiss="modal">&times;</button>
                                <h4 class="modal-title">تجميد المشروع</h4>
                            </div>
                            <div class="modal-body">
                                <div class="row">
                                    <div class="col-md-12">
                                        <form action="{{ route('FrozePro')}}" method="post">
                                            {{ csrf_field() }}

                                            <input type="hidden" name="id" value="{{ $mmmmmm->AID }}">

                                            <button type="submit" class="btn btn-warning">تجميد المشروع</button>
                                        </form>

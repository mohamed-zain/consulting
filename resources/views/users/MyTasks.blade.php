@extends('users.layout')
  ...
  <div class="col-md-12">
          <h3>
            ...
            <a href="{{ url('NewestTasks') }}" id="NewestTasks" class="btn btn-app pull-left">
            ...
            <div class="box-body no-padding">
              ...
              <div class="table-responsive mailbox-messages">
                ...
                <tr>
                  ...
                  <td>
                    @if($Single->TState == 0)
                    <a href="{{url('ReplayUTask')}}/{{ $Single->TID }}" ><i class="fa fa-edit btn btn-warning"></i></a>
                    @elseif($Single->TState == 1)
                    -----
                    @endif
                  </td>

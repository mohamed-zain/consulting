        ...
        <div class="col-md-12">
          <div class="box box-default">
            <div class="box-header with-border">
              <h3 class="box-title">نص الرد علي المهمة</h3>
            ...
            <div class="box-body no-padding">
              <div class="mailbox-read-info">
                <h3>موكلة للمهندس - {{ $Data->name }}</h3><br>
              ...
              <div class="mailbox-read-message">
                ...
                <p class="whitespace">{{ $Data->ReContent }}.</p>
                        ...
                        <ul class="mailbox-attachments clearfix">
                            <li>
                                ...
                                <div class="mailbox-attachment-info">
                                    <a href="{{url('storage/app/public')}}/{{ $Single->RTaskName }}" class="mailbox-attachment-name" target="_blank"><i class="fa fa-paperclip"></i> عرض المرفق</a>

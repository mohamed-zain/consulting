                        ...
                        <div class="col-sm-8">
                                <select  class="form-control select2" name="DocName" style="width: 100%" required>
                                    ...
                                    $ef = \App\Models\Documents::where('Bennar',$fn->Bennar)->pluck('DocType');
                                        echo $ef;
                                    ?>
                                <?php $__currentLoopData = App\Models\DocsType::whereNotIn('id',$ef)->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dct): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>

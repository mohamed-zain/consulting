...
<head>
	...
	<link rel="apple-touch-icon" sizes="76x76" href="<?php echo e(asset('dist/img/logo.png')); ?>" />
	<link rel="icon" type="image/jpg" href="<?php echo e(asset('dist/img/logo.png')); ?>" />
	<!--     Fonts and icons     -->
	<!-- CSS Files -->
	        ...
	        <div class="row">
		        <div class="col-sm-12 ">
		            ...
		            <div class="wizard-container">
						...
						<form action="<?php echo e(route('CheckUp')); ?>" method="POST" enctype="multipart/form-data"  id="Registrationform">
		                    	...
		                    	<div class="wizard-header">
									<div class="row">
										<div class="col-lg-2 col-md-2 col-sm-2 col-xs-2">
											<img src="<?php echo e(asset('dist/img/logo.png')); ?>" style="max-height: 80px;width: auto" class="img-responsive center">
										</div>
										...
										<div class="col-lg-2 col-md-2 col-sm-2 col-xs-2">
											<img src="<?php echo e(asset('dist/img/logo.png')); ?>" style="max-height: 80px;float: left!important;" class="img-responsive center">
										</div>
									</div>
...
<?php /**PATH /Applications/MAMP/htdocs/consulting/resources/views/wizard.blade.php ENDPATH**/ ?>
	...
	<div class="image-container set-full-height" style="background-image: url('public/slide3.jpg')">
	    ...
	    <a href="https://consulting.ko-sky.com">
	         <div class="logo-container">
	            <div class="logo">
	                <img src="<?php echo e(asset('logo202221.png')); ?>">
	            </div>
		                    	...
		                    	<div class="wizard-header">
									<div class="row">
										<div class="col-lg-2 col-md-2 col-sm-2 col-xs-2">
											<img src="<?php echo e(asset('logo20221.png')); ?>" style="max-height: 80px;width: auto" class="img-responsive center">
										</div>
										...
										<div class="col-lg-2 col-md-2 col-sm-2 col-xs-2">
											<img src="<?php echo e(asset('logo20221.png')); ?>" style="max-height: 80px;float: left!important;" class="img-responsive center">
										</div>
									</div>

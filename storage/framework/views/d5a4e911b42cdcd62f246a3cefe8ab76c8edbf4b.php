             ...
             $dtt = DB::table('emplyees')->select('Attached as at')->where('id','=',Auth::user()->EmpiD)->get();
                ...
                <?php endif; ?>
                  ...
                  <li class="user-footer">
                    ...
                    <div class="pull-left">
                      <a href="<?php echo e(url('logout')); ?>" class="btn btn-default btn-flat">تسجيل الخروج</a>
                    </div>
                  </li>
                </ul>
              </li>
...
<?php /**PATH /Applications/MAMP/htdocs/skyapp/resources/views/SUPPORT/header.blade.php ENDPATH**/ ?>
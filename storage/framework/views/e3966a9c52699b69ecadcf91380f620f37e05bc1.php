...
} elseif ($_instance->childHasBeenRendered('n3gREpE')) {
    $componentId = $_instance->getRenderedChildComponentId('n3gREpE');
    $componentTag = $_instance->getRenderedChildComponentTagName('n3gREpE');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('n3gREpE');
} else {
    $response = \Livewire\Livewire::mount('project-manager-notification');
    $html = $response->html();
    $_instance->logRenderedChild('n3gREpE', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
